...
def insert_to_fresh_MainSector(file_url, data, cnt_str):
    ...
    def receive_before_cursor_execute(conn, cursor, statement, params, context, executemany):
        ...
        print(f"Insert {file_name} to Fresh.{file_name}_New")
        if executemany:
            cursor.fast_executemany = True
    sector = file_url.split('/')[-1].split('.')[0].upper()
    #-------------------------------------------------------
...
def importMainSector(list_folder, url_hub, list_url ,cnt_str, sp_object,df_summ_file, Hub):
        ...
        for file_url in tqdm(list_url):  
            ...
            if len(df_dup) != 0:
                ...
                to_email = ['hcmcbi-intern04@savills.com.vn', 'hcmcbi-intern07@savills.com.vn']
...
def main():
    ...
    while(True):
        ...
        list_url, df_summ_file = getFile(list_folder, selected_sectors, url_hub)
